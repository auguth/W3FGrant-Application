...
Our PoCS research is documented here <i>INSERT LINK</i>. We have also included simulations on the research document to show how PoCS would behave if Ethereum used PoCS from its genesis block.
